      ...
      >
        <label class={style.optionTextFirst}>
          ...
          >
            ...
            <option value="lanczos3">图像Lanczos3滤波</option>
            <option value="mitchell">W.J.T.米歇尔压缩</option>
            <option value="catrom">样条插值-Rom</option>
            <option value="triangle">三角形双线性</option>
            <option value="hqx">hqx (像素艺术)</option>
            <option value="browser-pixelated">浏览器像素化</option>
            <option value="browser-low">浏览器质量低</option>
            <option value="browser-medium">浏览器中质量</option>
            <option value="browser-high">浏览器高质量</option>
          </Select>
        </label>
        <label class={style.optionTextFirst}>
          缩放:
